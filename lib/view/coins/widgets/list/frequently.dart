  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          titleSmall(text: "Frequently asked questions", color: PortColor.black),
          ListView.builder(
            shrinkWrap: true,
              ...
              return Column(
                ...
                children: [
                  Row(
                    children: [
                      titleMedium(
                          text: faqQuestions[index], color: PortColor.black),
                      const Spacer(),
                      IconButton(
                        icon: Icon(
                          expandedList[index]
          ...
          titleSmall(text: "Terms & Condition", color: PortColor.black),
          SizedBox(height: screenHeight * 0.04),
        ],
      ),
    );
