    ...
    return Expanded(
      child: ListView(
        ...
        children: [
          ...
          headingMedium(text: "Benefits", color: PortColor.gray),
          SizedBox(height: screenHeight * 0.02),
          Container(
                      ...
                      Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            titleMedium(text: "0", color: PortColor.black),
                          ],
                        ),
                      ),
                      Icon(
          ...
          SizedBox(height: screenHeight * 0.02),
          headingMedium(text: "Support and Legal", color: PortColor.gray),
          SizedBox(height: screenHeight * 0.02),
          Container(
            height: screenHeight * 0.18,
            padding: EdgeInsets.symmetric(
          ...
          SizedBox(height: screenHeight * 0.02),
          headingMedium(text: "Settings", color: PortColor.gray),
          SizedBox(height: screenHeight * 0.02),
          Material(
            elevation: 3.0,
            borderRadius: BorderRadius.circular(10.0),
            ...
            child: ListTile(
              ...
              title: titleMedium(text: "Log Out", color: PortColor.black),
              trailing: Icon(
                Icons.arrow_forward_ios_rounded,
                color: PortColor.black,
                size: screenHeight * 0.02,
